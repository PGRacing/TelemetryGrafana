...
path = 'C:/Users/malwi/Documents/MEGA/PGRacingTeam/000 telemetry_data/live test/ecumaster/'
    ...
    with open(filepath, 'r') as file:
        ...
        for row in data:
            ...
            if (float(row['MAP']) != 0 and float(row['CLT']) != 0):
                ...
                timestamp_grafana = datetime.datetime.now()# - datetime.timedelta(hours=2)
